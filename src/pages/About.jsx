...
//             <Link
//               to="/churches"
//               className="bg-atlantic text-white px-10 py-4 rounded-2xl font-bold transition-all duration-300 shadow-xl shadow-atlantic/20 hover:-translate-y-1"
//             >
//               Find a Church
//             </Link>
//             <Link
...
//             <div className="h-[2px] w-10 bg-crimson"></div>
//             <span className="text-[10px] font-black text-atlantic uppercase tracking-[0.4em]">Statement of Beliefs</span>
//           </div>
//           <div className="flex flex-col md:flex-row md:items-end justify-between mb-16 gap-4">
//             <h3 className="text-4xl md:text-5xl font-black text-navy-blue tracking-tighter">We Believe.</h3>
...
//           <div className="flex flex-col md:flex-row md:items-end justify-between mb-16 gap-4">
//             <div>
//               <p className="text-[10px] font-black text-atlantic uppercase tracking-[0.4em] mb-3">Core Values</p>
//               <h3 className="text-4xl md:text-5xl font-black text-navy-blue tracking-tighter">The Essence of Our Identity.</h3>
//             </div>
//             <p className="text-sm text-slate-400 font-light max-w-xs leading-relaxed">
...
//           <div className="flex items-center gap-4 mb-6">
//             <div className="h-[2px] w-10 bg-crimson"></div>
//             <span className="text-[10px] font-black text-atlantic uppercase tracking-[0.4em]">Our History</span>
//           </div>
//           <div className="flex flex-col md:flex-row md:items-end justify-between mb-16 gap-4">
//             <h3 className="text-4xl md:text-5xl font-black text-navy-blue tracking-tighter">The Nazarene Story.</h3>
//             <p className="text-sm text-slate-400 font-light max-w-xs leading-relaxed">
...
//                   <div className="w-1.5 h-1.5 rounded-full bg-atlantic"></div>
//                   <span className="text-[10px] font-black text-navy-blue uppercase tracking-[0.3em]">{theme}</span>
//                 </span>
//               ))}
//             </div> */}
//           </div>
...
//                 <p className="text-[10px] font-black text-atlantic uppercase tracking-[0.4em]">Unity in Holiness</p>
//               </div>
...
//                 <p className="text-[10px] font-black text-atlantic uppercase tracking-[0.4em]">A Mission to the World</p>
//               </div>
//               <p className="text-slate-500 text-sm font-light leading-relaxed mb-4">
...
//             <p className="text-[10px] font-black text-atlantic uppercase tracking-[0.4em] mb-3">Founding Father</p>
//             <h4 className="text-2xl font-black text-navy-blue-blue mb-4">Phineas F. Bresee</h4>
//             <p className="text-slate-500 text-sm font-light leading-relaxed">
...
//             <p className="text-[10px] font-black text-atlantic uppercase tracking-[0.4em] mb-4">Join the Family</p>
...
//             <Link
//               to="/churches"
//               className="inline-block bg-white text-navy-blue font-black px-12 py-4 rounded-2xl hover:bg-atlantic hover:text-white transition-all shadow-2xl shadow-black/30 text-sm uppercase tracking-widest"
//             >
//               Browse Churches
//             </Link>
//           </div>
...
//             </span>
//             <span className="flex-1 text-sm font-bold text-navy-blue group-hover:text-atlantic transition-colors">
//               {a.title}
//             </span>
...
//               <div className="pl-11">
//                 <div className="h-[1px] w-8 bg-crimson mb-4"></div>
...
<section className="relative py-20 md:py-28 px-4 md:px-6 text-center overflow-hidden bg-white">
  <div className="absolute top-0 right-0 w-96 h-96 bg-atlantic rounded-full blur-[120px] opacity-[0.08] -translate-y-1/2 translate-x-1/2"></div>

  <div className="relative z-10 max-w-2xl mx-auto">
    <span className="text-[10px] font-black text-crimson uppercase tracking-[0.4em] block mb-6">
      Church of the Nazarene
    </span>

    <h1 className="text-4xl md:text-5xl lg:text-6xl font-black text-white mb-6 uppercase tracking-tighter leading-tight">
      <span className="text-atlantic italic font-serif">Western Cape </span><span className="text-atlantic">District</span>
    </h1>

    <p className="text-base md:text-lg text-slate-500 font-light max-w-xl mx-auto leading-relaxed">
      A movement of 40 Great Commission churches woven into the fabric of the Cape, dedicated to making Christlike disciples in every community.
    </p>
  </div>
</section>

      {/* 2. Mission & Vision */}
      <section className="py-16 md:py-24 px-4 md:px-6 bg-white border-t border-slate-100">
        <div className="max-w-5xl mx-auto">

          <div className="flex flex-col lg:flex-row lg:items-start justify-between gap-10 md:gap-16 mb-16">
            <div>
              <span className="text-[10px] font-black text-crimson uppercase tracking-[0.4em] block mb-6">Our Calling</span>
              <h2 className="text-4xl md:text-5xl font-black text-navy-blue tracking-tighter leading-tight max-w-md">
                Empowering Pastors. <br />
                <span className="text-fynbos">Transforming Lives.</span>
              </h2>
            </div>
            <p className="text-slate-500 text-base font-light leading-loose max-w-md pt-1">
              We exist as a resource and support network for our local congregations —
              empowering pastors, developing leaders, and planting new churches that
              reflect the holiness and love of Jesus Christ across the Western Cape.
            </p>
          ...
          <div className="grid md:grid-cols-[140px_1fr] gap-6 md:gap-12 items-start">
            <p className="text-[10px] font-black text-atlantic uppercase tracking-[0.4em] pt-1">The Vision</p>
            <p className="font-light italic text-lg md:text-xl leading-relaxed text-navy-blue">
              &ldquo;To see a vibrant, holiness-centered Nazarene presence in every town of the Western Cape, bringing hope to the broken and light to the dark.&rdquo;
            </p>
          </div>
        </div>
      ...
      {/* 3. Statement of Mission */}
      <section id="mission" className="py-16 md:py-24 px-4 md:px-6 bg-white border-t border-slate-100">
        <div className="max-w-5xl mx-auto">
          <span className="text-[10px] font-black text-crimson uppercase tracking-[0.4em] block mb-6">Statement of Mission</span>
          <h3 className="text-4xl md:text-5xl font-black text-navy-blue tracking-tighter leading-tight mb-12 max-w-xl">
            Making Christlike <span className="text-fynbos">Disciples in the Nations.</span>
          </h3>

          <div className="grid md:grid-cols-2 gap-10 md:gap-16 items-start">
            <div>
              <p className="text-slate-500 text-base font-light leading-loose mb-6">
                We are a Great Commission church. As a global community of faith, we are commissioned to take the Good News of life in Jesus Christ to people everywhere and to spread the message of scriptural holiness across the lands.
              </p>
              <p className="text-slate-500 text-base font-light leading-loose">
                We strive to express the compassion of Jesus Christ to all persons along with our personal commitment to Christlike living. While the primary motive of the church is to glorify God, we are also called to actively participate in His mission — reconciling the world to Himself.
              </p>
            </div>
            ...
            <div className="flex flex-col">
              {missionEssentials.map((e, i) => (
                <div
                  key={i}
                  className={`flex items-start gap-6 py-6 ${i !== 0 ? 'border-t border-slate-200' : ''}`}
                >
                  <span className="text-[10px] font-black text-crimson tracking-[0.2em] shrink-0 w-6 pt-0.5">
                    {String(i + 1).padStart(2, '0')}
                  </span>
                  <div>
                    <h4 className="font-black text-navy-blue uppercase tracking-widest text-sm mb-1">{e.title}</h4>
      ...
      {/* 4. Statement of Beliefs */}
      <section id="beliefs" className="py-16 md:py-24 px-4 md:px-6 bg-white border-t border-slate-100">
        <div className="max-w-5xl mx-auto">
          <div className="flex flex-col md:flex-row md:items-end justify-between mb-12 gap-4">
            <div>
              <span className="text-[10px] font-black text-crimson uppercase tracking-[0.4em] block mb-6">Statement of Beliefs</span>
              <h3 className="text-4xl md:text-5xl font-black text-navy-blue tracking-tighter">We Believe.</h3>
            </div>
            <p className="text-sm text-slate-400 font-light max-w-xs leading-relaxed">
              The foundational convictions that unite every Church of the Nazarene.
          ...
          <div className="flex flex-col">
            {beliefs.map((b, i) => (
              <div
                key={i}
                className={`flex gap-6 py-5 ${i !== 0 ? 'border-t border-slate-200' : ''}`}
              >
                <span className="text-[10px] font-black text-crimson tracking-[0.2em] shrink-0 w-6 pt-0.5">{String(i + 1).padStart(2, '0')}</span>
                <p className="text-slate-500 text-sm leading-relaxed font-light">
                  <span className="font-bold text-navy-blue">We believe </span>{b}
                </p>
              </div>
      ...
      {/* 5. Core Values */}
      <section id="values" className="py-16 md:py-24 px-4 md:px-6 bg-white border-t border-slate-100">
        <div className="max-w-5xl mx-auto">
          <div className="flex flex-col md:flex-row md:items-end justify-between mb-12 gap-4">
            <div>
              <span className="text-[10px] font-black text-crimson uppercase tracking-[0.4em] block mb-6">Core Values</span>
              <h3 className="text-4xl md:text-5xl font-black text-navy-blue tracking-tighter">The Essence of Our Identity.</h3>
            </div>
            <p className="text-sm text-slate-400 font-light max-w-xs leading-relaxed">
              Our core values support the vision of our denomination and shape our culture.
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 border-t border-slate-200">
            {coreValues.map((v, i) => (
              <div
                key={i}
                className={`py-8 md:py-10 px-0 md:px-8 ${i !== 0 ? 'md:border-l border-slate-200 border-t md:border-t-0' : ''}`}
              >
                <h4 className="text-xl font-black text-crimson mb-4">{v.title}</h4>
                <p className="text-slate-500 text-sm leading-relaxed font-light">{v.desc}</p>
              </div>
      ...
      {/* 6. Articles of Faith */}
      <section id="articles" className="py-16 md:py-24 px-4 md:px-6 bg-white border-t border-slate-100">
        <div className="max-w-5xl mx-auto">
          <span className="text-[10px] font-black text-crimson uppercase tracking-[0.4em] block mb-6">Articles of Faith</span>
          <h3 className="text-3xl md:text-4xl lg:text-5xl font-black text-navy-blue tracking-tighter mb-8 max-w-2xl">The Constitution of Our Faith.</h3>
          <p className="text-slate-500 text-base font-light leading-loose max-w-6xl mb-12">
            In order that we may preserve our God-given heritage, the faith once delivered to the saints, especially the doctrine and experience of entire sanctification as a second work of grace, and also that we may cooperate effectually with other branches of the Church of Jesus Christ in advancing God's kingdom, we, the ministers and lay members of the Church of the Nazarene, in accordance with the principles of constitutional legislation established among us, do hereby ordain, adopt, and set forth as the fundamental law or Constitution of the Church of the Nazarene the Articles of Faith, the Covenant of Christian Character, and the Articles of Organization and Government here following, to wit:
          </p>
          <ArticlesOfFaith />
        </div>
      ...
      <section className="py-16 md:py-24 px-4 md:px-6 bg-white border-t border-slate-100">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="flex flex-col md:flex-row md:items-end justify-between mb-10 gap-4">
            <div>
              <span className="text-[10px] font-black text-crimson uppercase tracking-[0.4em] block mb-6">Our History</span>
              <h3 className="text-4xl md:text-5xl font-black text-navy-blue tracking-tighter">The Nazarene Story.</h3>
            </div>
            <p className="text-sm text-slate-400 font-light max-w-xs leading-relaxed">
              Tracing our roots from 1908 to a global movement of holiness.
          ...
          {/* Two themes */}
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-16 pt-10 border-t border-slate-200 mb-10">

            <div>
              <p className="text-[10px] font-black text-atlantic uppercase tracking-[0.4em] mb-4">Unity in Holiness</p>
              <p className="text-slate-500 text-sm font-light leading-relaxed mb-4">
                The spiritual vision of early Nazarenes was derived from the doctrinal core of John Wesley's preaching — justification by grace through faith, entire sanctification as an inheritance available to every Christian, and the witness of the Spirit to God's work in human lives.
              </p>
              <p className="text-slate-500 text-sm font-light leading-relaxed mb-4">
            ...
            <div>
              <p className="text-[10px] font-black text-atlantic uppercase tracking-[0.4em] mb-4">A Mission to the World</p>
              <p className="text-slate-500 text-sm font-light leading-relaxed mb-4">
                In 1908 there were churches in Canada and organized work in India, Cape Verde, and Japan, soon followed by work in Africa, Mexico, and China. As General Superintendent H. F. Reynolds advocated "a mission to the world," support for world evangelization became a distinguishing characteristic of Nazarene life.
              </p>
              <p className="text-slate-500 text-sm font-light leading-relaxed mb-4">
          ...
          {/* Phineas Bresee */}
          <div className="grid md:grid-cols-[220px_1fr] gap-6 md:gap-10 pt-10 border-t border-slate-200">
            <div>
              <p className="text-[10px] font-black text-crimson uppercase tracking-[0.4em] mb-2">Founding Father</p>
              <h4 className="text-2xl font-black text-navy-blue">Phineas F. Bresee</h4>
            </div>
            <p className="text-slate-500 text-sm font-light leading-relaxed pt-1">
              In 1907, Bresee led the Church of the Nazarene into a union with the Association of Pentecostal Churches of America. Meeting in Chicago for their First General Assembly, the two groups formalized their merger, adopting the name Pentecostal Church of the Nazarene and electing two general superintendents. Bresee was the first general superintendent elected, soon joined by H. F. Reynolds of Brooklyn as the second.
            </p>
          </div>
    ...
    <div className="border-t border-slate-200">
      {articles.map((a, i) => (
        <div key={i} className="border-b border-slate-200">
          <button
            onClick={() => setActive(active === i ? null : i)}
            className="w-full flex items-center gap-5 py-5 text-left hover:bg-slate-50 transition-colors group"
          >
            <span className="text-[10px] font-black tracking-[0.2em] text-crimson shrink-0 w-6">
              {String(i + 1).padStart(2, '0')}
            </span>
