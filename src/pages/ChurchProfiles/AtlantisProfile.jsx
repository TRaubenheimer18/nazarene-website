      ...
      <div ref={scrollRef} className="flex gap-6 overflow-x-auto px-2 pb-2" style={{ scrollbarWidth: 'none' }}>
        {pastors.map((pastor, i) => (
          <div key={i} className="flex flex-col items-center gap-3 shrink-0">
            <div className="w-20 h-20 rounded-full bg-[#FCFAF5] border border-slate-200 flex items-center justify-center">
    ...
    <div className="bg-white min-h-screen">
      ...
      <div className="max-w-5xl mx-auto px-6 py-12 space-y-0">
        ...
        <div className="py-10 border-t border-slate-200">
          ...
          <div className="flex flex-col sm:flex-row items-start gap-6">
            ...
            <div>
              <p className="text-[10px] font-black text-atlantic uppercase tracking-[0.3em] mb-1">Senior Pastor</p>
              <h3 className="text-2xl font-black text-navy-blue tracking-tighter mb-2">Rev. Nigel J. Kolkoto</h3>
              <p className="text-slate-500 text-sm font-light leading-relaxed max-w-xl">
                Rev. Nigel J. Kolkoto has served as Senior Pastor of Atlantis Church of the Nazarene for 17 years, leading the congregation with a heart for holiness, evangelism, and community transformation.
              </p>
            </div>
          </div>
        ...
        <div className="py-10 border-t border-slate-200">
          ...
          {pastorsOpen && (
            <PastorsCarousel pastors={localPastors} />
          )}
        </div>
        ...
        <div className="py-10 border-t border-slate-200">
          ...
          <div className="grid md:grid-cols-[160px_1fr] gap-4 md:gap-10 items-start">
            <p className="text-slate-500 text-sm font-light leading-relaxed">NMI, Evangelistic Ministry, Prison Ministry</p>
          </div>
        </div>
